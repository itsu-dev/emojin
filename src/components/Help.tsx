...
export default function Help() {
    ...
    return (
        <Wrapper>
            ...
            <Container ref={ref}>
                <p>emojin
                    は絵文字で記述する、まったく新しいプログラミング言語です。文字列を除く全ての記号やキーワードなどが絵文字に置き換わっています。</p>
                ...
                <h3>文字列</h3>
                <p>emojin では文字列はダブルクォーテーションで囲みます。文字列中に " を使うことはできません。</p>
                <p>例："Hello, World!"</p>
                ...
                <h3>比較演算</h3>
                <p>emojin では比較演算子に
                    ⚖️（天秤）のみが使えます。現在はこの絵文字が表す等価演算のみですが、今後拡張される予定です。</p>

                <h3>PRINT 文</h3>
                <p>PRINT 文は 💬（吹き出し）で始まり、その後に出力する式を記述します。また PRINT 文の最後には必ず

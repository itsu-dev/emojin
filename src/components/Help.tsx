    ...
    return (
        <Wrapper>
            ...
            <Container ref={ref}>
                ...
                <h3>比較演算</h3>
                <p>emojin では比較演算子に等価を⚖️（天秤）、&lt; を 👈（左向きの手）、&lt;= を 👈⚖️（左向きの手と天秤）、&gt; を
                    👉（左向きの手）、=&gt; を ⚖️👉（右向きの手と天秤）を使って表します。</p>
                ...
                <p>すでにある変数に代入するには、🔖（タグ）を除いた記述をします。emojin
                    での代入は式であるため、式が有効な部分ではどこでも記述することができます。</p>
                <p>例（変数 😇 の値を 1 増やす）：😇🫵😇➕1️⃣⛔️</p>
                ...
                <h3>繰り返し（WHILE 文）</h3>
                <p>WHILE 文は 🔁（リピート）で始まり、その後に条件式を記述します。そのあとにループごとに実行する文を 🔜（開始）と
                    🔚（終了）で囲って記述します。</p>
                <p>例（1〜10 の数字を出力する）：🔖❤️🫵0️⃣⛔️🔁❤️👉1️⃣0️⃣🔜📢❤️➕1️⃣⛔️❤️🫵❤️➕1️⃣⛔️🔚</p>
